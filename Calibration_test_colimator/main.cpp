...
int main(int argc, char* argv[]) {
 ...
 manager.registerTask([](){                                                                                                                                                                                
       return new JPetTaskLoader("phys.hit", "phys.hit.calib.check",    
				 new TaskD("check first rough time calibration with data measured with reference detector",                                                                                        
					    "Create time difference histograms"));       
     });
