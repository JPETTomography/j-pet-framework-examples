...
class Reconstructor{
 ...
 public:
  ...
  vector< vector<double> > FindIntersectionPointsOfCircles( TVector3 Hit1Pos, TVector3 Hit2Pos, TVector3 Hit3Pos, double R1, double R2, double R3, double R13, double R21, double R32 );
