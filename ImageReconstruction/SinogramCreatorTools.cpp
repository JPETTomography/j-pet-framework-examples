...
double SinogramCreatorTools::getPolyFit(std::vector<double> indepvar) {
  const std::vector<std::vector<double>> modelTerms {{6, 0}, {5, 1}, {5, 0}, 
                         {4, 2}, {4, 1}, {4, 0}, 
                         {3, 3}, {3, 2}, {3, 1}, 
                         {3, 0}, {2, 4}, {2, 3}, 
                         {2, 2}, {2, 1}, {2, 0}, 
                         ...
                         {0, 3}, {0, 2}, {0, 1}, 
                         {0, 0}                  };
  const std::vector<double> coefficients {-4.134801885659948e-07, -2.300107024422413e-08,  1.63726635335888e-05,
                                      1.73001508731807e-06,   1.359112755021784e-05, -0.0003483024181997085,
                                      3.0824911712077e-06,   -1.671743900149295e-05, -0.0002755710560288588,
                                      0.006195186956691909,   2.139575490180591e-06, -3.604595062410784e-05,
                                     -0.0001028583160383859,  0.001337241556475614,  -0.07459337521834991,
                                      4.354695109287826e-06,  7.061215552547179e-05,  0.0006737187696296268,
                                      0.002313067110373971,   0.002549526937584952,   0.3926701790901366,
                                      1.707921126250134e-06,  5.241438152857635e-06, -0.0005029848848941915,
                                     -0.005095141886803388,  -0.01607730907583253,   -0.03130108005714758,
                                      0.2797848665191068};
