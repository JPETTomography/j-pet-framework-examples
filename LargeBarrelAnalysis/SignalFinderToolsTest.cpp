...
BOOST_AUTO_TEST_CASE(getSigChsByEdge_test)
{
  ...
  vector<JPetSigCh> sigChFromSamePM;
  sigChFromSamePM.push_back(sigCh1);
  sigChFromSamePM.push_back(sigCh2);
  ...
  BOOST_REQUIRE_EQUAL(results1.size(), 3);
  BOOST_REQUIRE_EQUAL(results2.size(), 5);
}
...
BOOST_AUTO_TEST_CASE(validateSignal_test)
{
  ...
  JPetSigCh sigChA3(JPetSigCh::Tailing, 3.0);
  JPetSigCh sigChA4(JPetSigCh::Tailing, 4.0);
  ...
  JPetSigCh sigChB5(JPetSigCh::Tailing, 5.0);
  JPetSigCh sigChB6(JPetSigCh::Tailing, 6.0);
  JPetSigCh sigChB7(JPetSigCh::Tailing, 7.0);
  ...
  JPetSigCh sigChC3(JPetSigCh::Tailing, 3.0);
  JPetSigCh sigChC4(JPetSigCh::Tailing, 4.0);
...
BOOST_AUTO_TEST_CASE(buildRawSignals_test_trails)
{
  ...
  JPetSigCh sigCh1(JPetSigCh::Leading, 1.0);
  JPetSigCh sigCh2(JPetSigCh::Leading, 2.0);
  JPetSigCh sigCh3(JPetSigCh::Leading, 3.0);
  JPetSigCh sigCh4(JPetSigCh::Leading, 4.0);
  JPetSigCh sigCh5(JPetSigCh::Trailing, 6.0);
  JPetSigCh sigCh6(JPetSigCh::Trailing, 7.0);
  JPetSigCh sigCh7(JPetSigCh::Trailing, 8.0);
  JPetSigCh sigCh8(JPetSigCh::Trailing, 134.0);
  sigCh1.setThresholdNumber(1);
  sigCh2.setThresholdNumber(2);
  sigCh3.setThresholdNumber(3);
  sigCh4.setThresholdNumber(4);
  sigCh5.setThresholdNumber(2);
  sigCh6.setThresholdNumber(3);
  sigCh7.setThresholdNumber(1);
  sigCh8.setThresholdNumber(4);
  ...
  BOOST_REQUIRE_EQUAL(results.at(0).getPoints(JPetSigCh::Leading).size(), 4);
  BOOST_REQUIRE_EQUAL(results.at(0).getPoints(JPetSigCh::Trailing).size(), 3);
}
