    ...
    double sigChLeadTrailMaxTime)
{
  ...
  while (thresholdSigCh.at(0).size() > 0) {
    ...
    int nextThrSigChIndex1 = findSigChOnNextThr(thresholdSigCh.at(0).at(0).getValue(), thresholdSigCh.at(1), sigChEdgeMaxTime);
    if (nextThrSigChIndex1 != -1) {

      int closestTrailingSigCh1 = findTrailingSigCh(thresholdSigCh.at(1).at(nextThrSigChIndex1), thresholdSigCh.at(5), sigChLeadTrailMaxTime);
      if (closestTrailingSigCh1 != -1) {
        ...
        if (saveControlHistos) stats.getHisto1D("TOT_thr_2").Fill(tot1 / 1000.0);
    ...
    int nextThrSigChIndex2 = findSigChOnNextThr(thresholdSigCh.at(0).at(0).getValue(), thresholdSigCh.at(2), sigChEdgeMaxTime);
    if (nextThrSigChIndex2 != -1) {

      int closestTrailingSigCh2 = findTrailingSigCh(thresholdSigCh.at(2).at(nextThrSigChIndex2), thresholdSigCh.at(6), sigChLeadTrailMaxTime);
      if (closestTrailingSigCh2 != -1) {
        ...
        if (saveControlHistos) stats.getHisto1D("TOT_thr_3").Fill(tot2 / 1000.0);
    ...
    int nextThrSigChIndex3 = findSigChOnNextThr(thresholdSigCh.at(0).at(0).getValue(), thresholdSigCh.at(3), sigChEdgeMaxTime);
    if (nextThrSigChIndex3 != -1) {

      int closestTrailingSigCh3 = findTrailingSigCh(thresholdSigCh.at(3).at(nextThrSigChIndex3), thresholdSigCh.at(7), sigChLeadTrailMaxTime);
      if (closestTrailingSigCh3 != -1) {
        ...
        if (saveControlHistos) stats.getHisto1D("TOT_thr_4").Fill(tot3 / 1000.0);
  ...
  if (saveControlHistos) {
    stats.getHisto1D("remainig_leading_sig_ch_per_thr").Fill(1, thresholdSigCh.at(0).size());
    stats.getHisto1D("remainig_leading_sig_ch_per_thr").Fill(2, thresholdSigCh.at(1).size());
    stats.getHisto1D("remainig_leading_sig_ch_per_thr").Fill(3, thresholdSigCh.at(2).size());
    stats.getHisto1D("remainig_leading_sig_ch_per_thr").Fill(4, thresholdSigCh.at(3).size());
    stats.getHisto1D("remainig_trailing_sig_ch_per_thr").Fill(1, thresholdSigCh.at(4).size());
    stats.getHisto1D("remainig_trailing_sig_ch_per_thr").Fill(2, thresholdSigCh.at(5).size());
    stats.getHisto1D("remainig_trailing_sig_ch_per_thr").Fill(3, thresholdSigCh.at(6).size());
