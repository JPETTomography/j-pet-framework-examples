...
void TimeWindowCreator::initialiseHistograms(){
  ...
  // Flagging histograms
  getStatistics().createHistogram(new TH1F(
    "filter_sigch", "Number of good and corrupted SigChs created", 3, 0.5, 3.5
  ));
  ...
  getStatistics().createHistogram(new TH1F(
    "filter_LL_tdiff", "Time diff of LL pairs", 200, 0.0, 5000.0
  ));
  ...
  getStatistics().createHistogram(new TH1F(
    "filter_TT_tdiff", "Time diff of TT pairs", 200, 0.0, 50000.0
  ));
  ...
  getStatistics().createHistogram(new TH1F(
    "consec_lead_THR1", "Time diff of consecutive leadings THR1", 200, 0.0, 50000.0
  ));
